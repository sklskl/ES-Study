 ...
 */
package ls.tech.aspect;

import lombok.extern.slf4j.Slf4j;
import ls.tech.service.SysLogService;
import ls.tech.domain.SysLog;
import ls.tech.utils.RequestHolder;
...
public class LogAspect {
     ...
     * 配置切入点
     */
    @Pointcut("@annotation(ls.tech.annotation.Log)")
